...
class _AskQuestionState extends State<AskQuestion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Ask a Question', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  _buildLabel('Title'),
                  const Text('Be specific and imagine you’re asking a question to another person.', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
                  ...
                  const SizedBox(height: 24),
                  _buildLabel('Tags'),
                  const Text('Add up to 5 tags to describe what your question is about.', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
                  const SizedBox(height: 12),
                  TextField(controller: _tagsController, decoration: const InputDecoration(hintText: 'e.g. dart, mobile, ui')),
                  const SizedBox(height: 24),
                  _buildLabel('Description'),
                  const Text('Include all the information someone would need to answer your question.', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
                  const SizedBox(height: 12),
  ...
  Widget _buildLabel(String text) {
    return Padding(
      ...
      child: Text(text, style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
    );
  }
}
